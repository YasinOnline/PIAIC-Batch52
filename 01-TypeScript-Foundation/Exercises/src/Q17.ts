...
console.log(
  "I just found out that my new dinner table won't arrive in time, and I have space only for two guests.\n"
);
...
guests.length = 0;
console.log(
  "\nThe dinner party has been ended, no any guest left now. This is recent guests' list: ",
  guests
);

...
function checkNumber(divisible) {
...
const userDivisibleNumber = parseFloat(readlineSync.question("Enter a number to check divisibility: "));
const divisibleOrNot = checkNumber(userDivisibleNumber);
